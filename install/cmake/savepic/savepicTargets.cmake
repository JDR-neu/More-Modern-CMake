...
foreach(_expectedTarget savepic::savepic)
...
# Create imported target savepic::savepic
add_library(savepic::savepic SHARED IMPORTED)

set_target_properties(savepic::savepic PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv"
...
file(GLOB CONFIG_FILES "${_DIR}/savepicTargets-*.cmake")
